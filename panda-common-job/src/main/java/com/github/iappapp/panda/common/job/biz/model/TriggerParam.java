...
public class TriggerParam implements Serializable {
    ...
    public String toString() {
        return "TriggerParam{jobId=" + this.jobId + ", executorHandler='" + this.executorHandler + '\'' + ", executorParams='" + this.executorParams + '\'' + ", executorBlockStrategy='" + this.executorBlockStrategy + '\'' + ", executorTimeout=" + this.executorTimeout + ", logId=" + this.logId + ", logDateTime=" + this.logDateTime + ", glueType='" + this.glueType + '\'' + ", glueSource='" + this.glueSource + '\'' + ", glueUpdatetime=" + this.glueUpdatetime + ", broadcastIndex=" + this.broadcastIndex + ", broadcastTotal=" + this.broadcastTotal + '}';
    }
}
